A Bash script starts with "#!/bin/bash" It is called "Sha-Bang"; it tells the operating system where the bash interpreter is located, the path to the interpreter.
...
Aliases can be created using back-ticks (``) or $(), as below
